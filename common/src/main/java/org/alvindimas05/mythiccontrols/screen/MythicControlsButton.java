...
public class MythicControlsButton implements Drawable, Element, Selectable {
	public static final Identifier WIDGETS_TEXTURE = Identifier.of("mythiccontrols", "textures/gui/mythiccontrols_button.png");
	private final Text message = Text.translatable("mythiccontrols.mythicbutton");
	public int x;
	public int y;
	...
	public MythicControlsButton(int x, int y, PressAction onPress) {
		this.x = x;
		this.y = y;
	...
	public interface PressAction {
		void onPress(MythicControlsButton button);
	}
}
