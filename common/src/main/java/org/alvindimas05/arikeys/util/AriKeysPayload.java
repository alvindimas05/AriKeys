...
public interface AriKeysPayload {
	record Handshake(String value) implements CustomPayload {
		public static final Id<Handshake> ID = new Id<>(Identifier.of("arikeys:greeting"));
	...
	record AddKey(String value) implements CustomPayload {
		public static final Id<AddKey> ID = new Id<>(Identifier.of("arikeys:addkey"));
	...
	record Load(byte[] value) implements CustomPayload {
		public static final Id<Load> ID = new Id<>(Identifier.of("arikeys:load"));
	...
	record Key(String value) implements CustomPayload {
		public static final Id<Key> ID = new Id<>(Identifier.of("arikeys:keybind"));
