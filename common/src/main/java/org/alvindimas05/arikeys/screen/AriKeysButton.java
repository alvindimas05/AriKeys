package org.alvindimas05.arikeys.screen;
...
public class AriKeysButton implements Drawable, Element, Selectable {
	public static final Identifier WIDGETS_TEXTURE = Identifier.of("arikeys", "textures/gui/arikeys_button.png");
	...
	public AriKeysButton(int x, int y, PressAction onPress) {
		this.x = x;
		this.y = y;
